...
The public API lives at the module root (`github.com/go-ruby-vcr/vcr`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `vcr`, while the surface follows
...
```go
import "github.com/go-ruby-vcr/vcr"
```
...
- **[pkg.go.dev/github.com/go-ruby-vcr/vcr](https://pkg.go.dev/github.com/go-ruby-vcr/vcr)**

The module's [README](https://github.com/go-ruby-vcr/vcr#readme) carries worked
